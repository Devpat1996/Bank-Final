...
include("dbconfig.php");
	...
	if($con) {
      ...
      $color = $_SESSION['color'];
           $AC2 = $_SESSION['CheckingAC'];
     $SA2 = $_SESSION['SavingAC'];
     ...
     $LID = $_SESSION['LoanID'];
       ...
       $CID = $_SESSION['CheckingID'];
    		...
    		$Query = "SELECT * FROM dp428.accounts where Account!='Loan' and ID='$SID' or ID='$CID' ";
...
<h1>Choose an account from below to withdraw.</h1><br>
