...
$Account_Number = mysqli_real_escape_string($con,$_SESSION['Account']);
			$SQL = "SELECT * FROM dp428.statement where Account_Number='$LAN'order by Date DESC";
			$CON = mysqli_query($con,$SQL);

			$Check = "SELECT * FROM dp428.accounts where Account_Number='$LAN' and Account='Loan'";
	...
	<header>
        ...
        <nav class="top-menu active">
            ...
            <div class="components">
                ...
                <div class="logo">
                    <a href=""><span>Loan:</span>&nbsp$<?php echo "$VALUE"; ?></a>
                </div>
