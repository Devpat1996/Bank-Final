...
include("dbconfig.php");
    ...
    $CRYPT = $_SESSION['CRYPT'];
		$You = $_SESSION['YOU'];
		if(isset($user)) {
      $SQL = "SELECT * FROM dp428.user WHERE User='$CRYPT'";
...
<body>
    ...
    <div class="banner">
    	<div class="box">
    		<h1>Having a Great Day?<br>Before we begin select the type of account you want to create.</h1><br>

    		<form action="CreateAccount2.php" method="POST">

    		<div class="custom-select" style="width:200px;">
    		<select name="BankType">
    			<option value="Checking">Choose Account</option>
