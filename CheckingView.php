...
$Account_Number = mysqli_real_escape_string($con,$_SESSION['Account']);
			$SQL = "SELECT * FROM dp428.statement where Account_Number='$AC'order by Date DESC";
			$CON = mysqli_query($con,$SQL);

			$Check = "SELECT * FROM dp428.accounts where Account_Number='$AC' and Account='Checking'";
	...
	<header>
        ...
        <nav class="top-menu active">
            ...
            <div class="components">
                ...
                <div class="logo">
                    <a href=""><span>Checking:</span>&nbsp$<?php echo "$VALUE"; ?></a>
                </div>
			...
			<div class="wrap-table100">
				...
				$Statement = $rows['Statement']; ?>
									...
									<td class="cell100 column1"><?php echo "$Amount"; ?></td>
									 ...
									 <?php if($color=='') { ?><td class="cell100 column2" style="color: #37d72f"><?php echo "$Loan"; ?></td> <?php } else { ?>
									 	<td class="cell100 column2" style="color: <?php echo "$color"; ?>"><?php echo "$Loan"; ?></td>
									 		<?php } ?>
